	...
	function checkFlag() {
		...
		for(var i = 0; i < agreement.length; i++) {
			if(agreement[i].checked) {
				location.href = "join02.jsp?agreement=yes";
			}
			else {
				alert("약관에 동의해주세요.");
			}
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				...
				<form name="joinFrm" method="post" action="join02.jsp" 
				onsubmit="checkFlag(); return false;">
					<label>
						<p style="text-align:center; margin-bottom:20px;"><input type="checkbox" name="agreement" value="">이용약관과 개인정보취급방침에 동의합니다.</p>
					</label>
					<p style="text-align:center; margin-bottom:20px">
						<button type="submit"><img src="../images/btn01.gif" /></button>
