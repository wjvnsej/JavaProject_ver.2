...
<link rel="stylesheet" href="../common/css/calendal.css" />
	...
	<div id="wrap">
		...
		<div class="contents_box">
			...
			<div class="right_contents">
				<div class="top_title">
					<img src="../images/space/<%=boardName %>" class="con_title" />
			...
			<table align="center" width='100%' style="border: 1px solid black; table-layout: fixed; word-wrap:break-word;word-break:break-all; ">  
				<tr >
					<td align="left" height='50' valign="top" style="border: 0px;">  
						<button style="height: 40" type="button" class="btn btn-outline-primary" 
				...
				%>
						<td valign='top' align='left' height='92px' style="table-layout:fixed; word-break:break-all;"></td> 
				<% 
				}
				...
				%>
					<td valign='top' height='92px' style="overflow:hidden; text-overflow: ellipsis; white-space: nowrap;">
	  					<%=i %>
	  					<br />
				...
				<div class="container">
				    ...
				    %>
				    	<table style="table-layout: fixed;"  >
				        	<tr>
			        			<td width="250px;" height="230px;" style="border: 0px; " nowrap="nowrap">
			        	    		<a href="board_view.jsp?num=<%=dto.getNum() %>&nowPage=<%=nowPage %>&<%=queryStr %>">
								        <div class="grid_4"  style="padding: 5%; " >
								            <div class="img" >
								            	<div class="lazy-img">
								            		<img src=<%=path %> width="230px;" height="200px;">
								            	</div>
								            </div>
								            <br/>
			...
			<% }else {%>
					...
					<table class="table table-bordered table-hover table-striped" >
						...
						<!-- 리스트반복 start -->
							<tr>
								...
								<td class="text-left" width="400px;" style="overflow:hidden; text-overflow: ellipsis; display: block; white-space: nowrap;">
				...
				<div class="ml-auto" align="right">
					...
					<!-- 자유게시판과 질문과답변에서만 글쓰기 버튼 보임처리 -->
					<%if(bname.equals("freeboard") || bname.equals("photoboard") || bname.equals("infoboard")) {%>
						<button type="button" class="btn btn-primary" 
							onclick="location.href='board_write.jsp?bname=<%=bname %>';">글쓰기</button>
					<% } %>
					<%-- 
					<%if(bname.equals("notice") && !(session.getAttribute("grade").equals("user"))) { %>
						<button type="button" class="btn btn-primary" 
							onclick="location.href='board_write.jsp?bname=<%=bname %>';">글쓰기</button>
					<% } %>
					 --%>
